...
<div class="ebook-testimonials">
  ...
  <div class="ebook-testimonial">
    ...
    <p class="ebook-testimonial-author">- Filan Fisteku</p>
  </div>
  <div class="ebook-testimonial">
...
<div class="ebook-info">
  ...
  <ul class="ebook-features-list">
    <li class="ebook-features-item">
      <i class="fa fa-check-circle"></i> Industr best practices
    </li>
    <li class="ebook-features-item">
    ...
    <li class="ebook-features-item">
      <i class="fa fa-check-circle"></i> Practical exercises
    </li>
    <li class="ebook-features-item">
